...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        if ($type == 'verify') {
            ...
            $this->email->message('silahkan klick tombol berikut untuk aktivasi akun SIAP Bayar : <a href="' . base_url() . 
            'auth/verify?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '" type="button" style="color: green;">Activate</a>');

        } else if ($type == 'forgot') {
            $this->email->subject('Reset Password Akun SIAP Bayar');
            $this->email->message('silahkan klick tombol berikut untuk reset password akun SIAP Bayar : 
            <a href="' . base_url() . 'auth/resetpassword?email=' . $this->input->post('email') . '&token=' . urlencode($token) . 
            '" type="button" style="color: green;">Reset Password</a>');
        }
