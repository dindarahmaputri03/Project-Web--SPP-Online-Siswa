    ...
    <div class="card-body p-0">
      ...
      <div class="row">
        <div class="col-lg-5 d-none d-lg-block text-center">
          ...
          <p class="mb-5"><em class="text-primary">SPP Online Siswa</em></p>
          <p class="lead text-gray-900">SMPN 07 PANCA KARYA</p>
        </div>
        <div class="col-lg-7">
          <div class="p-4">
            ...
            <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
              <div class="form-group">
                <input type="text" class="form-control form-control-user" id="name" name="name" placeholder="Masukkan nama anda, contoh : Abid Taufiqur R" value="<?= set_value('name'); ?>">
